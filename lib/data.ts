...
export const artists: Artist[] = [
  { slug: "aura-vance", name: "AURA VANCE", genre: "SPATIAL AMBIENT", image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&q=80", coordinates: "52.5200°N, 13.4050°E", status: "ACTIVE", bio: "Berlin-based spatial audio architect. Pioneering immersive soundscapes that blur the boundary between acoustic phenomena and digital synthesis.", releases: 4, listeners: "2.4M", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "kael-drift", name: "KAEL DRIFT", genre: "INDUSTRIAL TECHNO", image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80", coordinates: "35.6762°N, 139.6503°E", status: "ACTIVE", bio: "Tokyo's foremost industrial sound designer. Raw frequencies shaped through architectural acoustics.", releases: 3, listeners: "1.8M", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "nova-echo", name: "NOVA ECHO", genre: "DARK AMBIENT", image: "https://images.unsplash.com/photo-1598387993441-a364f854c3e1?w=800&q=80", coordinates: "51.5074°N, 0.1278°W", status: "ACTIVE", bio: "London collective exploring the sonic properties of abandoned industrial spaces.", releases: 6, listeners: "890K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "void-architect", name: "VOID ARCHITECT", genre: "DRONE SYNTHESIS", image: "https://images.unsplash.com/photo-1571974599782-87624638275e?w=800&q=80", coordinates: "48.8566°N, 2.3522°E", status: "ACTIVE", bio: "Parisian composer working at the intersection of brutalist architecture and harmonic resonance.", releases: 2, listeners: "560K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "steel-meridian", name: "STEEL MERIDIAN", genre: "NOISE SCULPTURE", image: "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=800&q=80", coordinates: "40.7128°N, 74.0060°W", status: "ACTIVE", bio: "New York sound sculptor. Creating temporal installations using industrial waste frequencies.", releases: 5, listeners: "1.2M", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  ...
  { slug: "null-frequency", name: "NULL FREQUENCY", genre: "FIELD RECORDING", image: "https://images.unsplash.com/photo-1446057032654-9d8885db76c6?w=800&q=80", coordinates: "64.1466°N, 21.9426°W", status: "ACTIVE", bio: "Icelandic field recordist capturing the sonic signatures of volcanic landscapes.", releases: 3, listeners: "720K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "prism-decay", name: "PRISM DECAY", genre: "GLITCH AMBIENT", image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800&q=80", coordinates: "52.3676°N, 4.9041°E", status: "ARCHIVED", bio: "Amsterdam-based glitch artist. Deconstructing digital artifacts into meditative compositions.", releases: 7, listeners: "1.5M", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "monolith-sound", name: "MONOLITH SOUND", genre: "CONCRETE MUSIC", image: "https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=800&q=80", coordinates: "59.3293°N, 18.0686°E", status: "ACTIVE", bio: "Stockholm duo. Musique concrète informed by Scandinavian minimalist design principles.", releases: 4, listeners: "430K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "resonance-lab", name: "RESONANCE LAB", genre: "PSYCHOACOUSTICS", image: "https://images.unsplash.com/photo-1504898770365-14faca6a7320?w=800&q=80", coordinates: "34.0522°N, 118.2437°W", status: "EMERGING", bio: "Los Angeles research collective exploring the psychoacoustic properties of urban environments.", releases: 2, listeners: "280K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "ferro-static", name: "FERRO STATIC", genre: "ELECTROMAGNETIC", image: "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800&q=80", coordinates: "41.9028°N, 12.4964°E", status: "ACTIVE", bio: "Roman artist sonifying electromagnetic fields from ancient ruins and modern infrastructure.", releases: 3, listeners: "670K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
  { slug: "orbital-silence", name: "ORBITAL SILENCE", genre: "SPACE AMBIENT", image: "https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?w=800&q=80", coordinates: "28.6139°N, 77.2090°E", status: "ACTIVE", bio: "Delhi-based ambient producer. Translating satellite telemetry data into contemplative soundscapes.", releases: 5, listeners: "950K", socialLinks: { instagram: "#", soundcloud: "#", bandcamp: "#" } },
];
...
export const releases: Release[] = [
  {
    ...
    genre: "SPATIAL AMBIENT", format: "SPATIAL", image: "https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Engineered by Elias Thorne.",
  ...
  },
  {
    ...
    genre: "INDUSTRIAL TECHNO", format: "PHYSICAL", image: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Pressed at Optimal Media.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "DIGITAL MINIMALISM", format: "DIGITAL", image: "https://images.unsplash.com/photo-1509114397022-ed747cca3f92?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Mixed at Hackney Road Studios.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "DARK AMBIENT", format: "SPATIAL", image: "https://images.unsplash.com/photo-1535905557558-afc4877a26fc?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Spatial mix by Arc Audio Paris.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "STRUCTURAL SOUND", format: "PHYSICAL", image: "https://images.unsplash.com/photo-1504297050568-910d24c426d3?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Cut at Sterling Sound NYC.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "VOID ELECTRONICS", format: "DIGITAL", image: "https://images.unsplash.com/photo-1500534623283-312aade485b7?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Field recordings captured in Vatnajokull.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "SPECTRAL NOISE", format: "SPATIAL", image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&q=80", year: 2023,
    credits: "Mastered at NOVAVOX Berlin. Glitch processing by Prism Decay.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "CONCRETE MUSIC", format: "PHYSICAL", image: "https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?w=800&q=80", year: 2023,
    credits: "Mastered at NOVAVOX Berlin. Recorded at EMS Stockholm.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "ENCRYPTED AUDIO", format: "DIGITAL", image: "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Generative systems by Cipher Wave.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "FERRO NOISE", format: "SPATIAL", image: "https://images.unsplash.com/photo-1531971589569-0d9370cbe1e5?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. EM field recordings at Roman Forum.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "ORBITAL AMBIENT", format: "DIGITAL", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80", year: 2023,
    credits: "Mastered at NOVAVOX Berlin. Satellite data courtesy ISRO.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
  ...
  },
  {
    ...
    genre: "ACOUSTIC RESEARCH", format: "SPATIAL", image: "https://images.unsplash.com/photo-1517999144091-3d9dca6d1e43?w=800&q=80", year: 2024,
    credits: "Mastered at NOVAVOX Berlin. Psychoacoustic analysis by Resonance Lab.",
    streamingLinks: defaultStreamingLinks,
    tracks: [
...
export const journalEntries: JournalEntry[] = [
  { slug: "architecture-of-decay", issue: "042", title: "The Architecture of Decay", description: "How entropy shapes the sonic character of Berlin's abandoned industrial spaces. A photographic and acoustic study of controlled deterioration.", author: "Elias Thorne", duration: "14 MIN READ", readTime: "14 MIN READ", image: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=800&q=80", type: "ESSAY" },
  { slug: "resonance-in-void", issue: "802", title: "Resonance in the Void: The Minimalist Legacy", description: "Tracing the lineage from La Monte Young to contemporary spatial audio practitioners.", author: "Sarah Kovac", duration: "18 MIN READ", readTime: "18 MIN READ", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80", type: "NOTE" },
  { slug: "oscillator-drift", issue: "803", title: "Oscillator Drift: Humanizing the Machine", description: "The deliberate introduction of imperfection in modular synthesis.", author: "Marcus Vane", duration: "8 MIN READ", readTime: "8 MIN READ", image: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&q=80", type: "NOTE" },
  { slug: "sculpting-space", issue: "INT-001", title: "Sculpting Space: The Physics of Reverberation", description: "An in-depth conversation with acoustic architect Sarah Kovac on designing spaces for sound.", author: "Sarah Kovac", duration: "48:12", readTime: "48 MIN LISTEN", image: "https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&q=80", type: "INTERVIEW" },
  { slug: "beyond-24-bit", issue: "INT-002", title: "Beyond 24-Bit: The Quest for Infinite Resolution", description: "Marcus Vane discusses the philosophical implications of digital audio fidelity.", author: "Marcus Vane", duration: "32:05", readTime: "32 MIN LISTEN", image: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=800&q=80", type: "INTERVIEW" },
];
