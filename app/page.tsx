    ...
    <div className="space-y-32">
        ...
        <div className="max-w-4xl glide-content">
          ...
          >
            <div className="mono-label mb-6 flex items-center gap-4">
              ...
              SYSTEM_INIT_SUCCESSFUL
            </div>
            <h1 className="text-7xl md:text-9xl font-bold leading-[0.85] mb-8 tracking-tighter">
              THE ARCHITECTURE <br />
              <span className="text-white/20">OF SOUND</span>
            </h1>
            <p className="text-lg text-white/60 max-w-xl mb-12 leading-relaxed">
              NOVAVOX is a sonic research laboratory dedicated to the exploration of spatial sound, 
              architectural acoustics, and the intersection of physical space and digital audio.
            </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-white/10 border border-white/10">
        {[
          {
            title: 'SONIC OBJECTS',
            desc: 'Physical manifestations of digital soundscapes. Hand-crafted audio hardware.',
            icon: Box,
            link: '/catalog'
          },
          {
            title: 'SPATIAL INTEGRATION',
            desc: 'Architectural sound systems designed for immersive environments.',
            icon: Layers,
            link: '/integration'
          },
          {
            title: 'NARRATIVE JOURNEY',
            desc: 'Cinematic audio experiences that redefine the boundaries of storytelling.',
            icon: Music,
            link: '/narrative'
          }
        ].map((feature, i) => (
          ...
          >
            <feature.icon size={32} className="mb-8 text-white/40 group-hover:text-white transition-colors" />
      ...
      <section className="py-32 border-y border-white/10 flex flex-col items-center text-center">
        <div className="mono-label mb-8">MANIFESTO_01</div>
        <blockquote className="text-4xl md:text-6xl font-bold max-w-5xl leading-tight tracking-tighter italic">
          &quot;SOUND IS NOT JUST SOMETHING WE HEAR; IT IS A SPACE WE INHABIT. WE DON&apos;T BUILD SPEAKERS; WE ARCHITECT EXPERIENCES.&quot;
        </blockquote>
        <div className="mt-12 text-white/40 font-mono text-sm">— NOVAVOX DESIGN PRINCIPLES</div>
      </section>
    </div>
  );
}
