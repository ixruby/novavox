  ...
  const sections = [
        ...
        <BackgroundBeamsWithCollision className="h-full bg-[#0a0a0a]">
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6">
            <Image
              ...
              width={500}
              height={281}
              className="w-[260px] sm:w-[360px] md:w-[440px] object-contain"
              priority
            />
            <div className="mt-10 md:mt-14 flex flex-col md:flex-row items-center gap-6 md:gap-12 justify-center">
              ...
              <a
                ...
                className="group relative border border-white/20 px-10 py-4 overflow-hidden"
              >
    ...
    /* ═══ SERVICES (Top Right) ═══ */
    {
      ...
      children: (
        <WavyBackground
          className="h-full"
          containerClassName="h-full bg-[#0a0a0a]"
            ...
            <div className="max-w-5xl w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-[1px] bg-white/5">
                {[
                  ...
                  <div key={s.n} className="bg-black/50 backdrop-blur-sm p-6 md:p-8 hover:bg-white/5 transition-colors duration-500">
    ...
    /* ═══ CONTACT (Bottom Right) ═══ */
    {
      ...
      children: (
        <LampContainer className="h-full">
          ...
          >
            <div>
              <span className="font-mono text-[9px] uppercase tracking-[0.5em] text-white/30 mb-4 block">Get In Touch</span>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-2 pt-4">
                <a href="tel:+916282725324" className="font-mono text-[11px] tracking-widest text-white/30 hover:text-white transition-colors block">
                  +91 62827 25324
                </a>
                <a href="mailto:kaushik2002.22@gmail.com" className="font-mono text-[11px] tracking-widest text-white/30 hover:text-white transition-colors block">
